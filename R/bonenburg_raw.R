...
#'
#' This is the same dataset but the is unsorted and variables names are as
...
#'   \item{Al2O3 (\%)}{XRF Aliminium oxide in units weight percent of rock}
#'   \item{Na2O (\%)}{XRF Sodium oxide in units weight percent of rock}
#'   \item{K2O (\%)}{XRF Potasium oxide in units weight percent of rock}
