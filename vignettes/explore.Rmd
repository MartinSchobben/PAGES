...
In the following exercise I will use the packages `ggplot2` [@ggplot2; @ggplot22016] for plotting and `dplyr` [@dplyr] for data manipulations. Both pacakges are from the **tidyverse** collection.
